...
final class SFTPBrowserTests: XCTestCase {
    ...
    func testRemoteEditAssetsResolvesAgainstDirectoryAndRejectsEscapes() {
        ...
        XCTAssertNil(RemoteEditAssets.resolve(".vscode/tasks.json", relativeTo: "/srv"))
        XCTAssertNil(RemoteEditAssets.resolve("../.git/config", relativeTo: "/srv/docs"))
        XCTAssertEqual(RemoteEditAssets.resolve(".github/logo.png", relativeTo: "/srv"), "/srv/.github/logo.png")
