...
<p align="center">
  macOS 15+ · Universal · Developer ID 签名 · Apple 公证
</p>

![Berth 终端工作区：fastfetch 与 htop 分屏](docs/assets/shots/terminal-htop-1.8.0.png)
...
| 服务器视图 | 仪表盘展示 CPU、内存、磁盘、网络、负载等指标；Docker 面板可查看容器状态与日志。 |
